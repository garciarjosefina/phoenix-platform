...
def create_configured_bybit_demo_order_history_lookup(
    *,
    ...
    # Mismas credenciales/reloj/firma/recv_window que el resto del read-side
    # privado (Positions/Open Orders/Wallet Balance Read) -- /v5/order/history
    # es un endpoint autenticado (confirmado contra documentación oficial,
    # Hito 3.86), no público como Instrument Metadata.
    ...
    return create_bybit_demo_order_history_lookup(private_get_api=private_get_api)
