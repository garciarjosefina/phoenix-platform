...
def create_configured_bybit_demo_order_realtime_lookup(
    *,
    ...
    # privado -- /v5/order/realtime es un endpoint autenticado.
    ...
    return create_bybit_demo_order_realtime_lookup(private_get_api=private_get_api)
