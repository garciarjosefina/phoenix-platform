...
def create_configured_bybit_demo_open_orders_reader(
    *,
    ...
    # Mismas credenciales/reloj/firma/recv_window que Positions Read (Hito
    # 3.70) y el Port de ejecución -- Bybit Demo usa una única API key para
    # lectura y escritura, y el esquema de firma HMAC es idéntico.
    ...
    return create_bybit_demo_open_orders_reader(private_get_api=private_get_api)
