...
## Estado al 2026-08-01

- **Tag activo:** `v0.1.0`
- **Tests:** 3463 passing, 0 failing
...
- **Fase activa:** Fase 3 — Execution Gateway (ADR-001A implementado: camino de error desacoplado de Bybit)
